// Lite Grammar (Modified by duangsuse from JavaScript PEG.js Grammar)
//
// ==================
//
// Some rules from PEG.js JavaScript parser is Based on grammar from ECMA-262, 5.1 Edition [1].
//
...
// JavaScript Helper code from PEG.js JavaScript parser
{
...
PrimaryExpression
  ...
  / Literal
  / ArrayLiteral
  / "(" __ expression:MultiplicativeExpression __ ")" { return expression; }
...
IfStatement
  = IfToken __ "(" __ test:MultiplicativeExpression __ ")" __
...
ForStatement
  = ForToken __
    ...
    left:Identifier __
    InToken __
    right:MultiplicativeExpression __
    ")" __
    body:Statement
    {
      return {
...
ReturnStatement
  ...
  / ReturnToken _ argument:MultiplicativeExpression EOS {
